 ...
 *  2008 Erwin Pratama for GKJ Bekasi WIl Timur
  *  2011 Erwin Pratama for GKJ Bekasi Timur
 *
  ...
  switch ($ceDefRecurType){
    ...
    //
      ...
      if($numRows >0){
        ...
        $aEventStartHour = $ceStartTimeTokens[0];
        $aEventStartMins = $ceStartTimeTokens[1];
        echo "jam mingguan = $aEventStartHour\r\n";
        $aEventEndDate = $aEventStartDate;
        $aEventEndHour = $ceStartTimeTokens[0]+1;
        $aEventEndMins = $ceStartTimeTokens[1];
      }
...
<table cellpadding="3" width="75%" align="center">
  <caption>
    <h3><?php
        if($EventExists==0){
          echo gettext("Edit Kegiatan degan ID : (ID terbuat pada saat disimpan)");
        } else {
          echo gettext("Edit Kegiatan degan ID : ").($uEventID ? $uEventID:$aEventID);
        }
        ?></h3>
  </caption>
  <tr>
    <td colspan="4" align="center"><input type="button" class="icButton" <?php echo 'value="' . gettext("Menu") . '"'; ?> Name="Exit" onclick="javascript:document.location='Menu.php';"></td>
  </tr>
  <tr>
    <td colspan="4" align="center">
    <?php
    if ($bErrors != 0) {
        echo 'Ada '.$bErrors.' Pesan Kesalahan. Silahkan check kembali';
    }
    else
    {
        echo 'Informasi dengan tanda <font color="#ff0000">*</font> harus diisi';
    }
    ?>
    </td>
  </tr>
  <tr>
    <td class="LabelColumn"><font color="#ff0000">*</font><?php echo gettext("Type Kegiatan:"); ?></td>
  ...
  <tr>
    <td class="LabelColumn"><font color="#ff0000">*</font><?php echo gettext("Judul Kegiatan:"); ?></td>
    <td colspan="1" class="TextColumn">
      ...
      <?php if ( $bTitleError ) echo "<div><span style=\"color: red;\">" . gettext("Anda Harus memasukkan Judul.") . "</span></div>"; ?>
    </td>
    <td class="LabelColumn"><font color="#ff0000">*</font><?php echo gettext("Tempat Kegiatan:"); ?></td>
    <td colspan="1" class="TextColumn">
      <input type="text" name="EventDesc" value="<?php echo ($uEventDesc ? $uEventDesc:$aEventDesc); ?>" size="30" maxlength="100">
      <?php if ( $bDescError ) echo "<div><span style=\"color: red;\">" . gettext("Anda harus memasukkan informasi Tempat.") . "</span></div>"; ?>
    </td>
  </tr>

  <tr>
    <td class="LabelColumn"><font color="#ff0000">*</font>
      <?php echo gettext("Tanggal Mulai:"); ?><?php addToolTip("Format: YYYY-MM-DD<br>or enter the date by clicking on the calendar icon to the right."); ?>
    </td>
    <td class="TextColumn">
      ...
      <?php if ( $bESDError ) echo "<div><span style=\"color: red;\">" . gettext("Anda harus memassukan informasi tanggal mulai.") . "</span></div>"; ?>
    </td>
    <td class="LabelColumn"><font color="#ff0000">*</font>
      <?php echo gettext("Jam Mulai:"); ?>
    </td>
    <td class="TextColumn">
      ...
      <?php if ( $bESTError ) echo "<div><span style=\"color: red;\">" . gettext("Anda harus memasukkan informasi jam mulai.") . "</span></div>"; ?>
    </td>
  </tr>
  <tr>
    <td class="LabelColumn">
      <?php echo gettext("Tanggal Selesai:"); ?>
    </td>
    <td class="TextColumn">
  ...
  <tr>
    <td class="LabelColumn"><?php echo gettext("Kehadiran - Persembahan - Amplop"); ?></td>
    <td class="TextColumn" colspan="3">
      <input type="hidden" name="NumAttendCounts" value="<?php echo $nCnts; ?>">
      <?php
      if($nCnts==0){
      echo gettext("Maaf Tidak ditemukan Data");
      } else {
      ?>
    <table>
      <?php
      ...
      ?>
      <tr>
      <td><strong><?php echo gettext("Keterangan: "); ?></strong></td>
  ...
  <tr>
    <td class="LabelColumn"><?php echo gettext("Catatan Kebaktian:"); ?></td>
  ...
  <tr>
    <td class="LabelColumn"><font color="#ff0000">*</font><?php echo gettext("Status Kegiatan:"); ?></td>
    <td colspan="3" class="TextColumn">
      ...
      <?php if ( $bStatusError ) echo "<div><span style=\"color: red;\">" . gettext("Kegiatan ini aktif atau tidak aktif?") . "</span></div>"; ?>
    </td>
  </tr>

  <tr>
    <td colspan="2" align="center"><input type="submit" name="SaveChanges" <?php echo 'value="' . gettext("Simpan") . '"'; ?> class="icButton"></td>
  </tr>
</table>
</form>
