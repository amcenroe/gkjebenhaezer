...
//Get All Person ID
$sSQL = "SELECT per_ID FROM person_per WHERE per_cls_id < 6 AND per_WorkPhone like '%" . $iKelompok . "' ORDER BY per_fam_ID , per_fmr_ID , per_BirthYear ";
//$sSQL = "SELECT per_ID FROM person_per WHERE per_WorkPhone like '%" . $iKelompok . "'";
...
$sPageTitle = "Informasi Detail Data Jemaat (Versi Cetak), Kelompok :". $iKelompok;
...
<table border="0"  width="750" cellspacing=0 cellpadding=0>
  ...
  <tr><!-- Row 2 -->
     ...
     <img border="0" src="gkj_logo.jpg" width="110" >
     </td><!-- Col 1 -->
	...
	<?php echo "$sChurchAddress"." $sChurchCity"." $sChurchState"." $sChurchZip ";?></font><br>
	<font size="2" style="font-family: Arial; color: rgb(0, 0, 102);">
	<?php echo "Telp: "." $sChurchPhone " . "- Email: "." $sChurchEmail";?></font><br>
	<b><font size="3" style="font-family: Arial; color: rgb(0, 0, 102);">Data Warga Jemaat</font></b><br>
	<hr>
	<b style="font-family: Arial; color: rgb(0, 0, 102);">Nomor Induk Jemaat : <?php echo $per_ID,$per_fam_ID,$per_Gender,$per_fmr_ID ?>
	 		-- Kelompok :
	 		<?php
...
<?php
	...
	?>
		<tr class="<?php echo $sRowClass ?>">
			<td>
				<?php echo $per_FirstName . " "  . $per_MiddleName . " "  . $per_LastName ?>
				<br>
			</td>
			<td>
