...
/*******************************************************************************
 *
 *  filename    : PrintViewBinaNikah.php
 *
...
IF(a.BPNTempat>0,p.NamaGereja,a.BPNTempatNonGKJ) as BPNTempatNama,
p.Alamat1 as BPNTempatAlamat,
p.Alamat2 as BPNTempatAlamat2, 
p.Alamat3 as BPNTempatAlamat3,
p.Telp as BPNTempatTelp, 
p.Fax as BPNTempatFax
...
LEFT JOIN DaftarGerejaGKJ p ON a.BPNTempat = p.GerejaID
...
$sPageTitle = gettext("Surat Pengantar Pelayanan Titipan Bina Pra Nikah ".$NikahID."-".$NamaLengkapL."-".$NamaLengkapP);
$iTableSpacerWidth = 10;
require "Include/Header-Print.php";

	$logvar1 = "Print";
	$logvar2 = "View or Print Surat Pengantar Bina Nikah No.".$NikahID;
	//Update Logger
...
<table border="0"  width="600" cellspacing=0 cellpadding=0>
  <tr><!-- Row 1 -->
    ...
    <?php
						...
						$month = date('m',$time);
						$year  = date('Y',$time);
						//echo dec2roman(date (m)) ;echo "/"; echo date('Y'); STBN:Surat Titipan Bina Nikah
						$NomorSurat2 =  $NikahID."e/STBN/".$sChurchCode."/".dec2roman($month)."/".$year;
  ...
  echo "<td>".$sChurchCity.", </td><td>"; echo tanggalsekarang() ; date ('Y' ); echo " </td></tr>";
   echo "<tr><td valign=top>Hal:</td><td><font size=\"2\"> Permohonan Titipan Bina Pra Perkawinan</font></td></tr>";
   echo "<tr><td><font color=#FFFFFF>.</font></td></tr>";
   echo "<tr><td valign=top colspan=2 >Kepada YTH</td><td><font size=\"2\"></font></td></tr>";	

   echo "<tr><td valign=top colspan=2 ><font size=\"2\"><b> Majelis " . $BPNTempatNama . "</b></td><td><font size=\"2\"></font></td></tr>";
   echo "<tr><td valign=top colspan=2 ><font size=\"2\"><font color=#FFFFFF></font> " . $BPNTempatNama . "</font></td><td><font size=\"2\"></font></td></tr>";		   
   echo "<tr><td valign=top colspan=2 ><font size=\"2\"><font color=#FFFFFF></font> " . $BPNTempatAlamat1 . "</font></td><td><font size=\"1\"></font></td></tr>";	
  // if ($Alamat2<>""){
   echo "<tr><td valign=top colspan=2 ><font size=\"2\"><font color=#FFFFFF></font> " . $BPNTempatAlamat2 . "</font></td><td><font size=\"1\"></font></td></tr>";
  // }else{};	
  // if ($Alamat3<>""){
   echo "<tr><td valign=top colspan=2 ><font size=\"2\"><font color=#FFFFFF></font> " . $BPNTempatAlamat3 . "</font></td><td><font size=\"1\"></font></td></tr>";
 //  }else{};
   echo "<tr><td valign=top colspan=2 ><font size=\"2\"><font color=#FFFFFF></font> Telp " . $BPNTempatTelp . ",Fax " . $BPNTempatFax . "</font></td><td><font size=\"1\"></font></td></tr>";	
 ...
 Majelis ".$sChurchFullName." dengan ini menerangkan bahwa Saudara yang namanya tersebut di bawah ini, adalah anggota ".$sChurchFullName.":
 </font></td>"; 
 
//Laki2 Anggota
if ($per_ID_L>0 AND $per_ID_P>0){ 
  echo "<tr><td><img border=\"0\" src=\"\Images\Spacer.gif\" width=\"30\" height=\"1\" ></td>
 <td valign=top><font size=\"2\">  Nama </td><td>:</td><td><font size=\"2\">Sdr. <b>".$NamaLengkapL." </b></td></font><td></td></td>";
  echo "<tr><td><td valign=top><font size=\"2\">  No. Stmb </td><td>:</td><td><font size=\"2\"><b> " . $per_ID_L . " </b></td></font><td></td></td>";
  echo "<tr><td><td valign=top><font size=\"2\">  Tempat/Tanggal Lahir </td><td>:</td><td><font size=\"2\"><b> " . $TempatLahirL . " / " . date2Ind($TanggalLahirL,2) . "</b></td></font><td></td></td>";
if (isset($TempatBaptisAnakL)){  echo "<tr><td><td valign=top><font size=\"2\">  Tempat/Tanggal Baptis </td><td>:</td><td><font size=\"2\"><b> " . $TempatBaptisAnakL . " / " . date2Ind($TanggalBaptisAnakL,2) . "</b></td></font><td></td></td>";}
if (isset($TempatSidhiL)){   echo "<tr><td><td valign=top><font size=\"2\">  Tempat/Tanggal Sidhi </td><td>:</td><td><font size=\"2\"><b> " . $TempatSidhiL . " / " . date2Ind($TanggalSidhiL,2) . "</b></td></font><td></td></td>";}
  echo "<tr><td><td valign=top><font size=\"2\">  Nama Orang Tua </td><td>:</td><td><font size=\"2\"><b> " . $NamaAyahL . " / " . $NamaIbuL . "</b></td></font><td></td></td>";

  echo "<tr><td valign=top colspan=2><font size=\"2\">  Bermaksud menikah dengan </td><td>:</td><td><font size=\"2\"></td></font><td></td></td>";

  echo "<tr><td><img border=\"0\" src=\"\Images\Spacer.gif\" width=\"30\" height=\"1\" ></td>
 <td valign=top><font size=\"2\">  Nama </td><td>:</td><td><font size=\"2\">Sdri. <b>".$NamaLengkapP." </b></td></font><td></td></td>";
  echo "<tr><td><td valign=top><font size=\"2\">  No. Stmb </td><td>:</td><td><font size=\"2\"><b> " . $per_ID_P . " </b></td></font><td></td></td>";
  echo "<tr><td><td valign=top><font size=\"2\">  Tempat/Tanggal Lahir </td><td>:</td><td><font size=\"2\"><b> " . $TempatLahirP . " / " . date2Ind($TanggalLahirP,2) . "</b></td></font><td></td></td>";
if (isset($TempatBaptisAnakP)){echo "<tr><td><td valign=top><font size=\"2\">  Tempat/Tanggal Baptis </td><td>:</td><td><font size=\"2\"><b> " . $TempatBaptisAnakP . " / " . date2Ind($TanggalBaptisAnakP,2) . "</b></td></font><td></td></td>";}
if (isset($TempatSidhiP)){  echo "<tr><td><td valign=top><font size=\"2\">  Tempat/Tanggal Sidhi </td><td>:</td><td><font size=\"2\"><b> " . $TempatSidhiP . " / " . date2Ind($TanggalSidhiP,2) . "</b></td></font><td></td></td>";}
  echo "<tr><td><td valign=top><font size=\"2\">  Nama Orang Tua </td><td>:</td><td><font size=\"2\"><b> " . $NamaAyahP . " / " . $NamaIbuP . "</b></td></font><td></td></td>";

  
  }
   echo "<tr><td></td></tr>";
  echo "<tr><td valign=top colspan=\"4\"><font size=\"2\"> 
  Bersama surat ini Majelis ".$sChurchFullName." menitipkan <b>Pembinaan Pra-Perkawinan</b> bagi saudara tersebut kepada Majelis ".$BPNTempatNama.".
