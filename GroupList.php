...
//Set the page title
$sPageTitle = gettext('Daftar Kelompok');
...
if ($_SESSION['bManageGroups'])
{
	...
	echo gettext('Tambah Kelompok Baru') . '</a></p>';
}
...
echo '	<center><table cellpadding="4" cellspacing="0" width="70%">
		...
		<td>' . gettext('Nama Kelompok') . '</td>
		<td>' . gettext('Nama Lengkap Kelompok') . '</td>
		<td align="center">' . gettext('Jumlah Anggota') . '</td>
		<td align="center">' . gettext('Tipe') . '</td>
		</tr>';
