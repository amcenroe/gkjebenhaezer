...
/*******************************************************************************
 *
 *  filename    : PrintViewBaptisDewasaBeritaAcara.php
 *
...
$iTanggalBaptis = FilterInput($_GET["TanggalBaptis"],'date');
$iWaktuBaptis = FilterInput($_GET["WaktuBaptis"],'int');
...
left join DaftarPendeta e ON z.PendetaBaptis = e.PendetaID
		 ...
		 WHERE z.TanggalBaptis ='".$iTanggalBaptis."' AND z.WaktuBaptis =".$iWaktuBaptis;
...
$sPageTitle = gettext("Berita Acara Pelayanan Sakramen Baptis Tanggal.$iTanggalBaptis - $iWaktuBaptis");
...
<table  border="0"  width="600" cellspacing=0 cellpadding=0>
  ...
  <tr><!-- Row 2 -->
	 ...
	 <b><font FACE="Arial" size="5">Berita Acara</font> <font FACE="Arial" size="4"><br>Pelayanan Sakramen Baptis Dewasa<br></font></b>
	</td><!-- Col 3 -->
	</tr>

	<tr><td valign=top align=center >
	<font size="2" style="font-family: Arial; color: rgb(0, 0, 102);">
		 <?php $TGL=$iTanggalBaptis; ?>
	Berita Acara Nomor: <?php echo $TGL."/BABD/".$sChurchCode."/".strftime( "%Y", strtotime($TGL));?></font>
     </td></tr>
	 <tr></tr>
	<tr><td align=center colspan="2"> <br><?php echo date2Ind($iTanggalBaptis,1); ?></td><td></td></tr>
 	<tr><td align=center colspan="2"> <?php 
					if ($iWaktuBaptis == "11")
					{echo "06.00 WIB <br>Cut Meutia";}
					elseif ($iWaktuBaptis == "12"){echo "TI Cut Meutia ,Pukul 09.00 WIB ";}
					elseif ($iWaktuBaptis == "21"){echo "TI Cikarang ,Pukul 07.00 WIB ";}
					elseif ($iWaktuBaptis == "31"){echo "TI Karawang ,Pukul 07.30 WIB ";}
					elseif ($iWaktuBaptis == "41"){echo "TI Tambun ,Pukul 17.00 WIB ";}
					else{echo "";} ?>	
	</td><td></td></tr>
  ...
  <tr><!-- Row 1 -->
        ...
        while ($aRow = mysql_fetch_array($rsPerson))
        {
                ...
                <tr class="<?php echo $sRowClass ?>">
					...
					<td><font size="2" style="font-family: Arial; color: rgb(0, 0, 0);">Bp.<?php if (strlen($per_ID) > 0){echo $NamaAyah;}else{echo $NamaAyahNW;} ?>
					 / Ibu.<?php if (strlen($per_ID) > 0){echo $NamaIbu;}else{echo $NamaIbuNW;} ?>&nbsp;</font></td>
                </tr>
                <?php
        }
