...
//Set the page title
$sPageTitle = gettext('Detail Kelompok');
...
{
    echo '<a class="SmallText" href="GroupEditor.php?GroupID=' . $grp_ID . '">' . gettext('Edit Kelompok Ini') . '</a> | ';
    echo '<a class="SmallText" href="GroupDelete.php?GroupID=' . $grp_ID . '">' . gettext('Hapus Kelompok Ini') . '</a> | ';
...
//echo '<a class="SmallText" href="GroupMeeting.php?GroupID=' . $grp_ID . '&amp;Name=' . $grp_Name . '&amp;linkBack=GroupView.php?GroupID=' . $grp_ID . '">' . gettext('Jadwalkan Pertemuan') . '</a> | ';

echo '<a class="SmallText" href="MapUsingGoogle.php?GroupID=' . $grp_ID . '">' . gettext('Lihat di Peta') . '</a>';
...
if ($sEmailLink)
{
    ...
    // Display link
    echo ' | <a class="SmallText" href="mailto:'.$sEmailLink.'">'.gettext('Email Kelompok').'</a>';
        ...
        <div class="LightShadedBox">
            ...
            <table width="98%">
                <tr>
                    ...
                    <?php echo gettext('Jumlah Anggota:'); ?> <?php echo $iTotalMembers ?>
                    <br>
                    <?php echo gettext('Tipe:'); ?> <?php echo $sGroupType ?>
                    <br>
                    <?php echo gettext('Daftar:'); ?> <?php echo $sDefaultRole ?>
                    </font></div></td>
                </tr>
            </table>
        </div>
...
echo '</tr>';
echo '</table>';
echo '<b>' . gettext('Daftar Anggota Kelompok:') . '</b>';
?>

<iframe width="100%" height="800px" frameborder="0" align="left" marginheight="0" marginwidth="0" src="GroupMemberList.php?GroupID=<?php echo $iGroupID; ?>"></iframe>
<?php
