...
/*******************************************************************************
 *
 *  filename    : PrintViewBacaanAlkitab.php
...
//Minggu Ini
				...
				echo "<td><b>Hari & Tanggal</b></td>";
				echo "<td><b>Bacaan I</b></td>";
				echo "<td><b>Mazmur</b></td>";
				echo "<td><b>Bacaan II</b></td>";
				echo "<td><b>Injil</b></td>";
				echo "</tr>";
...
echo "<tr>";
echo "<td>".date2Ind($Tanggal,1)."</td>";
echo "<td><a target=\"_blank\" href=\"http://alkitab.sabda.org/passage.php?passage=" . $BacaanI . "&mode=print\" style=\"text-decoration:none;\">".$BacaanI."</a></td>";
echo "<td><a target=\"_blank\" href=\"http://alkitab.sabda.org/passage.php?passage=" . $Mazmur . "&mode=print\" style=\"text-decoration:none;\">".$Mazmur."</a></td>";
echo "<td><a target=\"_blank\" href=\"http://alkitab.sabda.org/passage.php?passage=" . $BacaanII . "&mode=print\" style=\"text-decoration:none;\">".$BacaanII."</a></td>";
echo "<td><a target=\"_blank\" href=\"http://alkitab.sabda.org/passage.php?passage=" . $Injil . "&mode=print\" style=\"text-decoration:none;\">".$Injil."</a></td>";
echo "</tr>";
}		
