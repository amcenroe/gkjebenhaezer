...
$photoFile = "Images/Person/thumbnails/" . $per_ID . ".jpg";
        ...
        {
		echo "<td><img src=\"Images/Person/thumbnails/" . $per_ID . ".jpg\" height=\"80\" ></td>";
		} else {
		echo "<td><img src=\"Images/NoPhoto.gif\" height=\"80\"  width=\"63\"></td>";

		}

//echo "<td><a target=\"_blank\" href=\"PersonView.php?PersonID=" . $per_ID . "&mode=print\" style=\"text-decoration:none;\">".$Nama."</a></td>";

echo "<td width=\"180\">".date2Ind($Tanggal,12)."</td>";
echo "<td width=\"80\">".$Kelompok."</a></td>";
echo "<td>".$Nama."</a></td>";
echo "</tr></table></li>";
}		
