  ...
  <tbody>
    <tr>
      <td style="font-family: Arial; width: 380px; text-align: left; color: rgb(0, 0, 102);" valign=top>
		...
		Grafik Persembahan Dewasa Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=14" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=14&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br><br>
		<? minavgmax(15,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Pemuda Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=15" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=15&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br><br>
		<? minavgmax(16,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Remaja Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=16" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=16&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br><br>
		<? minavgmax(17,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Anak Tahun : <?=$iTahun?> </a>
		</b><br>
		...
		<? minavgmax(18,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Syukur Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=18" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=18&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
		<br>
		<? minavgmax(19,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Bulanan Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=19" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=19&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
		<br>
		<? minavgmax(20,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Khusus Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=20" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=20&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
		<br>
		<? minavgmax(21,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Perpuluhan Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=21" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=21&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
		<br>
		<? minavgmax(22,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan PPPG Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=22" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=22&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
		<br>
		<? minavgmax(23,$iTahun);   ?>
				<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Bencana Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=23" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=23&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br><br>
		<? minavgmax(24,$iTahun);   ?>
						<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Persembahan Lain Lain Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=24" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=24&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
