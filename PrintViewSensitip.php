...
<?
$sSQL2="select count(*) as Jumlah, sum(Bulanan) as TotBulanan, sum(Syukur) as TotSyukur, sum(ULK) as TotULK from PersembahanBulanan where YEAR(Tanggal) > 2014 AND NomorKartu = $hasilGD[ID]";

				$perintah1 = mysql_query($sSQL2);
				//$i = 0;
							...
							//	$i++;
													...
													//Alternate the row color
								                    $sRowClass = AlternateRowStyle($sRowClass);
								  echo $hasilGD1[Jumlah];
								  echo "</td>";
								  echo "<td>";
								   echo $hasilGD1[TotBulanan];
								  echo "</td>";
								  echo "<td>";
								    echo $hasilGD1[TotSyukur];
								  echo "</td>";
								  echo "<td>";
								     echo $hasilGD1[TotULK];
	}
