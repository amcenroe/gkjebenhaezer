...
//Bulan Ini
				...
				echo "<td colspan=\"4\"><font face=\"Arial\" size=\"3\"><b>Keluarga yang ber-ULANG TAHUN PERKAWINAN bulan ini</b></font></td>";
...
CONCAT(
'Bp.',(SELECT per_firstname from person_per where person_per.per_fmr_id = '1' AND person_per.per_fam_id = a.fam_id AND per_cls_ID<3),' &<br> ',
'Ibu.',(SELECT per_firstname from person_per where person_per.per_fmr_id = '2' AND person_per.per_fam_id = a.fam_id AND per_cls_ID<3)) as 'Nama'
...
$photoFile = "Images/Family/thumbnails/" . $fam_ID . ".jpg";
        ...
        {
		echo "<img src=\"Images/Family/thumbnails/" . $fam_ID . ".jpg\" height=\"160\"   width=\"250\">";
		} else {
		echo "<img src=\"Images/NoFamPhoto.gif\" height=\"160\"  width=\"250\">";

		}
		
echo "<td width=\"800\"> ".date2Ind($Tanggal,12)." <br> Keluarga kelompok ".trim($Kelompok)." <br> ".$Nama." <br></td>";
