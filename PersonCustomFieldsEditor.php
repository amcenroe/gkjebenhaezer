...
$sPageTitle = gettext("Editor Jemaat Kustom");
...
?>
	...
	<input type="button" class="icButton" value="<?php echo gettext("Keluar"); ?>" Name="Exit" onclick="javascript:document.location='Menu.php';">
	</center>
<?php
}
else
...
?>
	<tr><td colspan="7">
	<center><b><?php echo gettext("PERHATIAN: Tanda Panah dan Tanda Hapus jika diklik akan langsung bereffect.  Perubahan akan HILANG jika tidak menekan tombol SIMPAN!"); ?></b></center>
	</td></tr>
