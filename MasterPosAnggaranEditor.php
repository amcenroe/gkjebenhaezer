...
/*******************************************************************************
 *
 *  filename    : MasterPosAnggaranEditor.php
...
if (isset($_POST["MasterPosAnggaranSubmit"]) || isset($_POST["MasterPosAnggaranSubmitAndAdd"]))
{
	...
	Keterangan = '" . $sKeterangan . "',
		...
		// Check for redirection to another page after saving information: (ie. MasterPosAnggaranEditor.php?previousPage=prev.php?a=1;b=2;c=3)
		if ($previousPage != "") {
		...
		else
		{
			...
			Redirect("MasterPosAnggaranEditor.php&amp;$refresh");
		}
...
<form method="post" action="MasterPosAnggaranEditor.php?PosAnggaranID=<?php echo $iPosAnggaranID; ?>" name="MasterPosAnggaranEditor">
