...
$TahunTimestamp = date("Y");
$SelisihTahun = $TahunTimestamp - $THNSKR ;
...
echo "	</tr>";
		$sSQL = "SELECT CONCAT('<a href=PrintViewKlasUmur.php?GID=$refresh&GenderID=',per_Gender,'&amp;Klas=$klasumur&amp;Uawal=$umurawal&amp;Uakhir=$umurakhir&amp;lstID=1&amp;clsID=3 target=_blank >',IF(per_gender ='1', 'Laki laki', 'Perempuan'),'  ') as Jemaat , count(per_ID) as Jiwa
			FROM person_per
...
echo "	<tr>";
echo "	<td><b> > </b></td>";
echo "	<td><a href=\"PrintViewKelompok.php?GID=$refresh&Status=$kelompok \" target=\"_blank\">";
...
echo "	<tr class=" . $sRowClass . ">" ;
echo "	<td><a href=\"PrintViewKelompok.php?GID=$refresh&Status=$kelompok&Hub=$i \" target=\"_blank\"><font size=2>" . $i . "</font></a></td>";
...
$sSQL = "SELECT count(per_ID) FROM person_per WHERE per_cls_ID = 1 AND YEAR(per_DateEntered) = 2009 ";
$perintah = mysql_query($sSQL);
$jemaataktifmandiri2009 = mysql_result($perintah,0);

$sSQL = "SELECT count(per_ID) FROM person_per WHERE per_cls_ID = 2";
$perintah = mysql_query($sSQL);
$jemaattitipan = mysql_result($perintah,0);

$sSQL = "SELECT count(per_ID) FROM person_per WHERE per_cls_ID = 2 AND YEAR(per_DateEntered) = 2009 ";
$perintah = mysql_query($sSQL);
$jemaattitipanmandiri2009 = mysql_result($perintah,0);
...
// Get the list of Meninggal per Tahun
function kematianth($TAHUNTH) {
$sSQL = "select count(*) from person_per natural join person_custom where per_cls_id = 7 AND YEAR(c41) = $TAHUNTH";
$perintah = mysql_query($sSQL);
$kematiantahunth = mysql_result($perintah,0); 
if ( $kematiantahunth == "0" ) 
{ return "0"; } else { return $kematiantahunth; }
}
...
// Get the list of Pindah per Tahun
function pindahth($TAHUNTH) {
$sSQL = "select count(*) from person_per natural join person_custom where (c9 is not null AND 
( c9 !='Pindah Agama' AND c9 !='PindahAgama' AND c9 !='pindah agama' AND c9 !='pindahagama' AND c9 !='Pindahagama' AND c9 !='Pindah agama')
) AND YEAR(c10) = $TAHUNTH";
$perintah = mysql_query($sSQL);
$pindahtahunth = mysql_result($perintah,0); 
if ( $pindahtahunth == "0" ) 
{ return "0"; } else { return $pindahtahunth; }
}
...
// Get the list of Pindah Agama Tahun ini per bulan
function pindahagmth($TAHUNTH) {
$sSQL = "select count(*) from person_per natural join person_custom where (c9 is not null AND 
 ( c9 ='Pindah Agama' OR c9 ='PindahAgama' OR c9 ='pindah agama' OR c9 ='pindahagama' OR c9 ='Pindahagama' OR c9 ='Pindah agama') 
  ) AND YEAR(c10) = $TAHUNTH";
$perintah = mysql_query($sSQL);
$pindahagmtahunth = mysql_result($perintah,0); 
if ( $pindahagmtahunth == "0" ) 
{ return "0"; } else { return $pindahagmtahunth; }
}
...
function atestasith($TAHUNTH) {
$sSQL = "select count(*) from person_per natural join person_custom where c8 is not null AND per_cls_id = 1 AND
YEAR(per_membershipdate) = $TAHUNTH ";
$perintah = mysql_query($sSQL);
$atestasitahuninith = mysql_result($perintah,0); 
if ( $atestasitahuninith == "0" ) 
{ return "0"; } else { return $atestasitahuninith; }
}
...
function baptisdewasath($TAHUNTH) {
$sSQL = "select count(*) from person_per natural join person_custom where YEAR(c18) = $TAHUNTH ";
$perintah = mysql_query($sSQL);
$baptisdewasath = mysql_result($perintah,0); 
if ( $baptisdewasath == "0" ) 
{ return "0"; } else { return $baptisdewasath; }
}
...
function titipanth($TAHUNTH) {
$sSQL = "select count(*) from person_per natural join person_custom where ( per_cls_id = '2' 
AND YEAR(per_membershipdate) = $TAHUNTH ) AND 
(( (c2 is not NULL AND c2<>'0000-00-00 00:00:00') 
AND c27 is not NULL ) OR ( (c18 is not NULL AND c18<>'0000-00-00 00:00:00') AND c28 is not NULL) OR c15 = 2 )";
//echo $sSQL;
$perintah = mysql_query($sSQL);
$jemaatdewasatitipth = mysql_result($perintah,0); 
if ( $jemaatdewasatitipth == "0" ) 
{ return "0"; } else { return $jemaatdewasatitipth; }
}
...
function kelahiranth($TAHUNTH) {
$sSQL = "select count(*) from person_per natural join person_custom, family_fam
where person_per.per_fam_id = family_fam.fam_id AND per_BirthYear = $THNSKR 
order by per_workphone, per_FirstName";
$perintah = mysql_query($sSQL);
$kelahiranth = mysql_result($perintah,0); 
if ( $kelahiranth == "0" ) 
{ return "0"; } else { return $kelahiranth; }
}
...
<table
 ...
 border="0" cellpadding="2" cellspacing="2">
  <tbody>
	...
	<font size="2"><big style="font-family: Arial;"><?php echo $SelisihTahun;?> Laporan (Executive Sumary) - Tahun <? echo $THNSKR ?></big><br></font></b>   
	<b style="font-family: Arial;">dilaporkan bulan : <?php echo date("F, Y"); ?></b></td>
    </tr>
	<tr>
	<td align="left">
	<?
				echo "<a href=\"LapBulanan.php?GID=$refresh&Tahun=".($iTahun-1)."\"  ><p class=\"help\" title=\"Data Sebelumnya Tahun: ".($iTahun-1)." \">";
				echo "<<</a>"
	?>
	</td>
	<td></td>
	<td align="right">
		<?
				echo "<a href=\"LapBulanan.php?GID=$refresh&Tahun=".($iTahun+1)."\"  ><p class=\"help\" title=\"Data Berikutnya Tahun: ".($iTahun+1)." \">";
				echo ">></a>"
	?>
	</td>
	</tr>
...
<td><font size=2><ALIGN=left> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=93 target=_blank>Kelahiran</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<td><font size=2> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=97 target=_blank>Baptisan Anak(*)</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<td><font size=2> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=99 target=_blank>Baptisan Dewasa</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<td><font size=2> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=98 target=_blank>Sidi(*)</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<td><font size=2> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=71 target=_blank>Pindahan/Atestasi</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<td><font size=2> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=95 target=_blank>Titipan</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<tr>
<td><font size=2><ALIGN=center> 1 </font></td>
<td><font size=2><ALIGN=left> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=91 target=_blank>Kematian</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<tr class="2">
<td><font size=2> 2 </font></td>
<td><font size=2> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=73 target=_blank>Pindah</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<tr class="3">
<td><font size=2> 3 </font></td>
<td><font size=2> <a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID= target=_blank>Pindah Agama</a> </font></td>
<?php
$i=1;
$datatemp=0;
while($i<=12)
...
<table style="width: 750;  text-align: left; margin-left: auto; margin-right: auto;" border="0" cellpadding="2" cellspacing="2" valign=top>
 <?php
//echo "Tahun sekarang :". $THNSKR;
//echo "TahunTimestamp :". $TahunTimestamp;
//echo "Selisih Tahun:". $SelisihTahun;
 if ($TahunTimestamp > $THNSKR){
$datatempkematianth=0;
$datatemppindahth=0;
$datatemppindahagmth=0;
$datatempkelahiranth=0;
$datatempatestasith=0;
$datatemptitipanth=0;
$datatempbaptisdewasath=0;

$iA=1;
while($iA<=$SelisihTahun)
  {
  $TAHUNTH=$THNSKR+$iA;
  $datatempkematianth = $datatempkematianth + kematianth($TAHUNTH);
  $datatemppindahth = $datatemppindahth + pindahth($TAHUNTH);
  $datatemppindahagmth = $datatemppindahagmth + pindahagmth($TAHUNTH);

  $datatempkelahiranth = $datatempkelahiranth + kelahiranth($TAHUNTH);
  $datatempatestasith = $datatempatestasith + atestasith($TAHUNTH);
  $datatemptitipanth = $datatemptitipanth + titipanth($TAHUNTH);
  $datatempbaptisdewasath = $datatempbaptisdewasath + baptisdewasath($TAHUNTH);


//echo "<td><font size=2> <ALIGN=center>";  echo $TAHUNTH;  echo "</font></td>";

 
  //echo $TAHUNTH;
  $iA++;
  }
   $jemaataktifselisih = $datatempkematianth + $datatemppindahth + $datatemppindahagmth - $datatempkelahiranth - $datatempatestasith;
   $jemaattitipanselisih = $datatemptitipanth ;

   echo $datatemptitipanth;

 }

$JumlahTotalJemaat = $jemaataktifmandiri2009 + $jemaataktifselisih +$jemaattitipanselisih;
...
?>
    ...
    <td style="font-family: Arial; width: 380px; text-align: left; color: rgb(0, 0, 102);" valign=top>
		...
		<tr><td align="left">Jumlah Total Jemaat</td><td>:</td><td align="right"><?php echo $JumlahTotalJemaat ?></td><td>jiwa</td></tr>
		<tr><td align="left"><font size=2>-- Jemaat Aktif</font></td><td>:</td><td align="right"><?php echo $jemaataktif+$jemaataktifselisih;?></td><td>jiwa</td></tr>
		<tr><td align="left"><font size=2>-- Jemaat Titipan</font></td><td>:</td><td align="right"><?php echo $jemaattitipan-$jemaattitipanselisih?></td><td>jiwa</td></tr>
		...
		<tr><td> .</td></tr>
		<tr><td><font size=2>  1.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=68 target=_blank><b>Jemaat Dewasa Total</b><br>(Sidhi/BaptisDewasa/Menikah)</a></font></td>
		<td><ALIGN=right>
		<font size=2><?php echo $sumjemaatdewasa ?> </font></td><td><font size=2> jiwa</font></td></tr>
		<tr><td><font size=2>  ....a.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=168 target=_blank>Belum Menikah </a></font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaatdewasasingle ?> </font></td><td><font size=2> jiwa</font></td></tr>
		<tr><td><font size=2>  ....b.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=169 target=_blank>Sudah Menikah </a></font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaatdewasamarried ?> </font></td><td><font size=2> jiwa </font></td></tr>
		<tr><td><font size=2>  ....c.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=68 target=_blank>Janda / Duda</a></font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaatJanda ?> </font></td><td><font size=2> jiwa</font></td></tr>
		<tr><td><font size=2>  ....d.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=68 target=_blank>Tidak Ada Data</a></font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaatND ?> </font></td><td><font size=2> jiwa</font></td></tr>		

		<tr><td><font size=2><b>  2.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID= target=_blank>Jemaat Dewasa Titipan Total</a></b><br>(Sidhi/BaptisDewasa/Menikah)</font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaatdewasatitip ?> </font></td><td><font size=2> jiwa</font></td></tr>
		<tr><td><font size=2>  ....a.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID= target=_blank>Belum Menikah</a></font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaatdewasasingletitip ?> </font></td><td><font size=2> jiwa</font></td></tr>
		<tr><td><font size=2>  ....b.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID= target=_blank>Sudah Menikah</a></font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaatdewasamarriedtitip ?> </font></td><td><font size=2> jiwa</font></td></tr>
		<tr><td><font size=2>  ....c.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID= target=_blank>Janda / Duda</a></font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaattitipJanda ?> </font></td><td><font size=2> jiwa</font></td></tr>
		<tr><td><font size=2>  ....d.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID= target=_blank>Tidak Ada Data</a></font></td><td><ALIGN=right>
		<font size=2><?php echo $sumjemaattitipND ?> </font></td><td><font size=2> jiwa</font></td></tr>				

		<tr><td><font size=2><b>  3.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=67 target=_blank>Jemaat Anak Total</a></b><br></font></td><td><ALIGN=right>
...
<tr><td><font size=2>  1.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=71 target=_blank>Attestasi Masuk</a></font></td><td><ALIGN=right>
...
<tr><td><font size=2>  2.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=95 target=_blank>Titipan dari Gereja lain</a></font></td><td><ALIGN=right> 
<font size=2><?php echo $sumjemaatdewasatitiptahunini ?></font></td><td><font size=2> jiwa</font></td></tr>

<tr><td><font size=2>  3.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=99 target=_blank>Baptis Dewasa </a></font></td><td><ALIGN=right>
<font size=2><?php echo $sumbaptisdewasa ?> </font></td><td><font size=2> jiwa</font></td></tr>

<tr><td><font size=2>  4.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=98 target=_blank>Sidhi </a></font></td><td><ALIGN=right>
...
<tr><td><font size=2>  1.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=93 target=_blank>Kelahiran Tahun ini </a></font></td><td><ALIGN=right>
...
<tr><td><font size=2>  2.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=97 target=_blank>Baptis Anak </a></font></td><td><ALIGN=right>
...
<tr><td><font size=2> 1.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=73 target=_blank> Jemaat Pindah  </a></font></td><td><ALIGN=right>
<font size=2><?php echo $sumpindah ?> </font></td><td><font size=2> jiwa</font></td></tr>
<tr><td><font size=2> 2.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID= target=_blank> Meninggal</a></font></td><td><ALIGN=right>
<font size=2><?php echo $summeninggal ?> </font></td><td><font size=2> jiwa</font></td></tr>
<tr><td><font size=2> 3.<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID= target=_blank> Jemaat Pindah Agama </a></font></td><td><ALIGN=right>
	...
	<td style="font-family: Arial; width: 380px; text-align: left; color: rgb(0, 0, 102);" valign=top>
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=85 target=_blank><?=$hasilMajelis[Jabatan]?></a></font></td>
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=86 target=_blank>Badan Pembantu Majelis</a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>
		<?	
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=87 target=_blank>Pengurus Kelompok</a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>
				<?	
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=176 target=_blank><?=$hasilMajelis[Jabatan]?></a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>		
		</table>
	...
	<table table style="text-align: left; width: 80%;" border="0" cellpadding="0" cellspacing="0">
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=178 target=_blank><?=$hasilMajelis[Jabatan]?></a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>		
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=179 target=_blank><?=$hasilMajelis[Jabatan]?></a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>	
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=177 target=_blank><?=$hasilMajelis[Jabatan]?></a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>	
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=175 target=_blank><?=$hasilMajelis[Jabatan]?></a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>	
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=180 target=_blank><?=$hasilMajelis[Jabatan]?></a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>	
		...
		$perintah = mysql_query($sSQL);
			...
			while ($hasilMajelis=mysql_fetch_array($perintah)){
				...
				<tr class="<?php echo $sRowClass; ?>">
				<td>*</td>
				<td><font size=2><a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=181 target=_blank><?=$hasilMajelis[Jabatan]?></a></font></td>
				<td ALIGN=right><font size=2><?=$hasilMajelis[Jumlah]?>  jiwa</font></td>
				</tr>
				<?}?>
...
<tr>
      ...
      <br><b>Status Kewargaan</b><br>
		...
		<?php
		$sSQL = "select  CONCAT('<a href=PrintViewStatusWarga.php?GID=$refresh&Status=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as StatusKewargaan, count(a.per_ID) as Jumlah
	  ...
	  <table table style="text-align: left; width: 80%;" border="0" cellpadding="0" cellspacing="0">
	  <?php
  		$sSQL = "select CONCAT('<a href=PrintViewGender.php?GID=$refresh&GenderID=',per_Gender,' target=_blank >',per_Gender,'  ') as Gender ,
...
$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=20&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as GolDarah, count(a.per_ID) as Jumlah
						from person_per a , person_custom b , list_lst c
...
$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=23&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as Status, count(a.per_ID) as Jumlah
						from person_per a , person_custom b , list_lst c
						WHERE a.per_ID = b.per_ID AND b.c15 = c.lst_OptionID AND c.lst_ID = 23 AND per_cls_id < 3
						GROUP BY c.lst_OptionName ORDER by lst_OptionSequence";
				$perintah = mysql_query($sSQL);
   ...
   <tr>
       ...
       <?php
 		...
 		?>
 			...
 			<?php
 				$sSQL = "select CONCAT('<a href=PrintViewUltah.php?GID=$refresh&Bulan=',per_BirthMonth,' target=_blank>',nama_bulan,'</a>') as Bulan,
...
$sSQL = "SELECT
    ...
    GROUP BY UmurNikah";
				...
				$sRowClass = AlternateRowStyle($sRowClass);
 				...
 				<td> </td>
 				<td>
				<a href=QueryView.php?GID=<?php echo $refresh; ?>&QueryID=101 target=_blank>
...
//						GROUP BY c.lst_OptionName ORDER by lst_OptionSequence";
$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=18&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as Pendidikan, count(a.per_ID) as Jumlah
						from person_per a , person_custom b , list_lst c
...
//						GROUP BY c.lst_OptionName ORDER by lst_OptionSequence";
$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=17&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as Pekerjaan, count(a.per_ID) as Jumlah
						from person_per a , person_custom b , list_lst c
...
//						GROUP BY c.lst_OptionName ORDER by lst_OptionSequence";
$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=19&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as Jabatan, count(a.per_ID) as Jumlah
						from person_per a , person_custom b , list_lst c
...
//						GROUP BY c.lst_OptionName ORDER by lst_OptionSequence";
$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=24&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as Profesi, count(a.per_ID) as Jumlah
						from person_per a , person_custom b , list_lst c
...
//				GROUP BY c.lst_OptionName ORDER by lst_OptionSequence";
			$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=25&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as Minat, count(a.per_ID) as Jumlah
				from person_per a , person_custom b , list_lst c
...
//						GROUP BY c.lst_OptionName ORDER by lst_OptionSequence";
		$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=26&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as Minat, count(a.per_ID) as Jumlah
						from person_per a , person_custom b , list_lst c
...
//					GROUP BY c.lst_OptionName ORDER by lst_OptionSequence";
				...
				$sSQL = "select CONCAT('<a href=PrintViewReport.php?GID=$refresh&clsID=3','&amp;','lstID=22&amp;','lstOptionID=',c.lst_OptionID,' target=_blank>',c.lst_OptionName,'</a>') as Hobi, count(a.per_ID) as Jumlah
					from person_per a , person_custom b , list_lst c
