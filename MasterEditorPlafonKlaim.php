...
if (isset($_POST["PengeluaranKlaimAsuransiSubmit"]) || isset($_POST["PengeluaranKlaimAsuransiSubmitAndAdd"]))
{
	...
	//If no errors, then let's update...
		...
		else if (isset($_POST["PengeluaranKlaimAsuransiSubmit"]))
		{
			...
			Redirect("SelectListApp3.php?mode=PengeluaranKlaimAsuransi");

		}
		else
		{
			//Reload to editor to add another record
			Redirect("PengeluaranKlaimAsuransiEditor.php");
		}
...
echo "SelectListApp3.php?mode=PengeluaranKlaimAsuransi";
} else {echo "SelectListApp3.php?mode=PengeluaranKlaimAsuransi"; 
} ?>';">
		</td>
	</tr>
