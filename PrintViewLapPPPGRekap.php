...
require "Include/Header-Report.php";
				...
				echo "<td align=\"left\">";
				echo "<a href=\"PrintViewLapPPPGRekap.php?TGL=".$yearago."&Rekap=".$iRekap."\"  >";
				...
				echo "<td align=\"right\">"; 
				echo "<a href=\"PrintViewLapPPPGRekap.php?TGL=".$nextyear."&Rekap=".$iRekap."\"  >";
...
// Detail Laporan
			...
			if($iRekap!=YES){		
				...
				echo "<tr><td bgcolor=\"#BBFFFF\" colspan=\"5\" align=\"center\" ><b>Penerimaan</b></td><tr>";
			}
		...
		if($iRekap!=YES){		
			echo "<tr><td>-</td><td colspan=\"2\" ><b><font size=\"2\" >Saldo Tahun ".($ThnKemaren-1)."</font></b></td><td colspan=\"12\" ></td>
			<td><b><font size=\"2\" >".currency(' ',$SaldoThnKemaren,'.',',-')."</font></b></td></tr>";
		}else{
			echo "<tr><td>-</td><td colspan=\"2\" ><b><font size=\"2\" >Saldo Tahun ".($ThnKemaren-1)."</font></b></td>
			<td align=\"right\" ><b><font size=\"2\" >".currency(' ',$SaldoThnKemaren,'.',',-')."</font></b></td></tr>";
			...
			while ($aRow = mysql_fetch_array($rsJadwal))
			{
				...
				echo "<td colspan=\"1\" ><font size=\"2\" >".$Pos."</font></td><td align=\"left\"><font size=\"2\" >".$Keterangan."</font></td>";
			...
			//Data Perbulan				
				...
				echo "<td align=\"right\"><font size=\"2\" ><b>".currency(' ',$GTotalSerapan1,'.',',-')."</b></font></font></td></tr>";
				echo "</tr>";
			}
			echo "<tr>";
			echo "<td align=\"right\" colspan=\"3\"><font size=\"2\" >Total Persembahan</font></td>";
			...
			$tbul2 = 0;
				...
				while ($aRow = mysql_fetch_array($rsPPPGPerBulan2))
					...
					$GTotalSerapan2+=$TotalPerBulan2;
							if($iRekap!=YES){	
								echo "<td align=\"right\"><font size=\"2\" ><b>".currency(' ',$TotalPerBulan2,'.',',-')."</b></font></td>";
							}
					}
		
				}
				
		echo "<td align=\"right\"><b><font size=\"2\" >".currency(' ',$GTotalSerapan2,'.',',00')."</b></font></td>";
...
// Akumulasi
			echo "<tr>";
			echo "<td align=\"right\" colspan=\"3\"><font size=\"2\" >Akumulasi Persembahan</font></td>";
			...
			$tbul2 = 0;
				...
				while ($aRow = mysql_fetch_array($rsPPPGPerBulan2))
					...
					$GTotalSerapan2+=$TotalPerBulan2;
								if($iRekap!=YES){	
								echo "<td align=\"right\"><font size=\"2\" ><b>".currency(' ',$GTotalSerapan2,'.',',-')."</b></font></td>";
								}
					}
		
				}
				
		echo "<td align=\"right\"><b><font size=\"2\" >".currency(' ',$TotalPemasukan,'.',',00')."</b></font></td>";
		$TotalPemasukan=$GTotalSerapan2+$SaldoThnKemaren;
		//$TotalPemasukan=$GTotalSerapan2;
			echo "</tr>";			
			...
			echo "<tr>";
			echo "<td align=\"right\" colspan=\"3\"><font size=\"2\" >Total Pengeluaran</font></td>";
...
// Akumulasi 
		...
		if($iRekap!=YES){		
			...
			echo "<tr><td bgcolor=\"#BBFFFF\" colspan=\"3\" align=\"center\" ><b>Saldo</b></td>";
		}

	
		
			echo "<td align=\"right\" bgcolor=\"#BBFFFF\" colspan=\"2\"><b><font size=\"2\" >".currency(' ',$TotalPemasukan-$GTotalSerapan2,'.',',00')."</b></font></td><tr>";
			echo "</tbody></table>";
			echo "<br>";
			echo "<br>";
