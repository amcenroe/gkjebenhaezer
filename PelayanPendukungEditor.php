...
if (isset($_POST["SuratSubmit"]) || isset($_POST["SuratSubmitAndAdd"]))
{
	...
	$sDressCode = FilterInput($_POST["DressCode"]);
	$sStola = FilterInput($_POST["Stola"]);	
...
//$rsNamaMultimedia2 = mysql_data_seek($rsNamaMultimedia1, 0); 
...
{ echo "SelectListApp3.php?mode=PelayanPendukung&amp;$refresh"; 
	...
	<tr>
	<td class="LabelColumnHL" <?php addToolTip(""); ?> colspan="2" ><b><?php echo gettext("Pelayan Pendukung Peribadahan:"); ?></b></td>
	</tr>
	<tr>
	...
	<tr>
	<td class="LabelColumnHL" <?php addToolTip(""); ?> colspan="2" ><b><?php echo gettext("Sekolah Minggu:"); ?></b></td>
	</tr>
	<tr>
	...
	<tr>
	<td class="LabelColumnHL" colspan="2"  <?php addToolTip(""); ?>  ><b><?php echo gettext("Pendukung Peribadahan lainnya:"); ?></b></td>
	<td class="LabelColumnHL" colspan="2"  <?php addToolTip(""); ?>  ><b><?php echo gettext("Majelis yg bertugas:"); ?></b></td>
	</tr>
	...
	<tr>
				...
				<td class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Koordinator"); ?></td>
				<td class="TextColumn">
	...
	<tr>	
				...
				<td class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Liturgos 1"); ?></td>
				<td class="TextColumn">
					<select name="Majelis2">
						<option value="" selected><?php echo gettext("Tidak Diketahui"); ?></option>
						<?php
						mysql_data_seek($rsMajelis, 0); 
						while ($aRow = mysql_fetch_array($rsMajelis))
						{
							extract($aRow);
							if ($vol_id == 2) { $MjlType = "Pnt." ; }else{ $MjlType = "Dkn." ; }								
	...
	<tr>
				<td rowspan="2" class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Multimedia:"); ?></td>
				<td>
				...
				<td class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Liturgos 2"); ?></td>
				<td class="TextColumn">
	...
	<td class="TextColumn">
			<select name="KodeMultimedia2">
						<option value="0" selected><?php echo gettext("Tidak Ada Pelayan"); ?></option>
						<?php
						mysql_data_seek($rsNamaMultimedia1, 0); 
						//while ($aRow = mysql_fetch_array($rsNamaMultimedia2)) ASLI
						while ($aRow = mysql_fetch_array($rsNamaMultimedia1))
						{
							extract($aRow);
							echo "<option value=\"" . $KodeMultimedia1 . "\"";
							if ($sKodeMultimedia2 == $KodeMultimedia1) { echo " selected"; }
							echo ">" . $NamaMultimedia1 . "-" . $Kelompok ;
						}
						?>
					</select>
	</td>
				<td class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Lektor 1"); ?></td>
				<td class="TextColumn">
	...
	<tr>
	<td class="LabelColumnHL" <?php addToolTip(""); ?> colspan="2" ><b><?php echo gettext("Dress Code dan Stola:"); ?></b></td>

				<td class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Lektor 2"); ?></td>
				<td class="TextColumn">
					<select name="Majelis5" disabled>
						<option value="" selected><?php echo gettext("Tidak Diketahui"); ?></option>
						<?php
						mysql_data_seek($rsMajelis, 0); 
						while ($aRow = mysql_fetch_array($rsMajelis))
	...
	<tr>
	<td class="LabelColumn"><?php echo gettext("Dress Code :"); ?></td>
		<td class="TextColumnWithBottomBorder" >
			<select name="DressCode" >
				<option value="0" <?php if ($sDressCode == "") { echo " selected"; }?> ><?php echo gettext("Tidak Diketahui"); ?></option>
				<option value="Bebas Rapi"  <?php if ($sDressCode == "Bebas Rapi") { echo " selected"; }?> ><?php echo gettext("Bebas Rapi"); ?></option>
				<option value="Batik"  <?php if ($sDressCode == "Batik") { echo " selected"; }?> ><?php echo gettext("Batik"); ?></option>
				<option value="Jas Resmi"  <?php if ($sDressCode == "Jas Resmi") { echo " selected"; }?> ><?php echo gettext("Jas Resmi"); ?></option>
				<option value="Nuansa Gelap"  <?php if ($sDressCode == "Nuansa Gelap") { echo " selected"; }?> ><?php echo gettext("Nuansa Gelap"); ?></option>
				<option value="Nuansa Putih"  <?php if ($sDressCode == "Nuansa Putih") { echo " selected"; }?> ><?php echo gettext("Nuansa Putih"); ?></option>
	
			</select>
		</td>
				<td class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Pendamping SM"); ?></td>
				<td class="TextColumn">
	...
	<tr>
	<td class="LabelColumn"><?php echo gettext("Stola :"); ?></td>
		<td class="TextColumnWithBottomBorder" >
			<select name="Stola" >
				<option value="0" <?php if ($sStola == "") { echo " selected"; }?> ><?php echo gettext("Tidak Diketahui"); ?></option>
				<option value="Putih"  <?php if ($sStola == "Putih") { echo " selected"; }?> ><?php echo gettext("Putih"); ?></option>
				<option value="Hitam"  <?php if ($sStola == "Hitam") { echo " selected"; }?> ><?php echo gettext("Hitam"); ?></option>
				<option value="Ungu"  <?php if ($sStola == "Ungu") { echo " selected"; }?> ><?php echo gettext("Ungu"); ?></option>
				<option value="Merah"  <?php if ($sStola == "Merah") { echo " selected"; }?> ><?php echo gettext("Merah"); ?></option>
				<option value="Hijau"  <?php if ($sStola == "Hijau") { echo " selected"; }?> ><?php echo gettext("Hijau"); ?></option>
	
			</select>
		</td>
				<td class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Pendamping Remaja"); ?></td>
				<td class="TextColumn">
	...
	<td></td>
	<td></td>
				<td class="LabelColumn" <?php addToolTip(""); ?>><?php echo gettext("Pendamping Pemuda"); ?></td>
				<td class="TextColumn">
					<select name="Majelis8" disabled>
						<option value="" selected><?php echo gettext("Tidak Diketahui"); ?></option>
						<?php
						mysql_data_seek($rsMajelis, 0); 
						while ($aRow = mysql_fetch_array($rsMajelis))
