...
// Get this Sidhi Anak Data
// $sSQL = "SELECT * FROM sidhigkjbekti WHERE SidhiID = " . $iSidhiID;
$sSQL = "select a.* , z.SidhiID, z.NoSuratTitipan, z.PendetaSidhi,
		...
		g.NamaGereja as NamaGerejaGKJ,
		g.Alamat1 as Alamat1Gereja,
		g.Alamat2 as Alamat2Gereja,
		g.Alamat3 as Alamat3Gereja,
		g.Telp as TelpGereja,
		g.Fax as FaxGereja,
		g.Email as EmailGereja,
		
		z.NoSuratTitipan as NoSuratTitipanNW, 
		x.c1 as TanggalBaptis,
		x.c26 as TempatSidhi,
...
left join DaftarGerejaGKJ g ON z.WargaGereja = g.GerejaID 
...
$sPageTitle = gettext("Surat Pengantar Pelayanan Pengakuan Percaya  No.".$NomorInduk."-".$NamaPemohonBaptis."-".$NamaPemohonBaptisNW);
...
<table border="0"  width="600" cellspacing=0 cellpadding=0>
  <tr><!-- Row 1 -->
   ...
   echo "<tr><td valign=top>Nomor Surat:</td><td><font size=\"2\">  " . $SidhiID . "e/SKPBA/".$sChurchCode."/"; echo dec2roman(date (m)) ;echo "/"; echo date('Y');"</font></td>";
  
  echo "<td>".$sChurchCity.", </td><td>"; echo tanggalsekarang() ; date ('Y' ); echo " </td></tr>";
   echo "<tr><td valign=top>Hal:</td><td><font size=\"2\"> Surat Keterangan Pelayanan Pengakuan Percaya </font></td></tr>";
 ...
 Bersama surat ini kami Majelis ".$sChurchFullName." dengan ini menerangkan bahwa Saudara yang namanya tersebut di bawah ini, 
 sudah dilayankan Pelayanan Pengakuan Percaya  :</font></td>"; 
 ?>
  <?php 
 ...
 echo "<tr><td><td valign=center><font size=\"2\">  Mengaku Percaya tanggal </td><td>:</td><td valign=center><b><font size=\"2\"> ";?>
 ...
 echo "<tr><td><td valign=center><font size=\"2\">  Tempat </td><td>:</td><td valign=center><b><font size=\"2\"> ";?>
  ...
  echo "<tr><td><td valign=center><font size=\"2\">  Dilayani oleh </td><td>:</td><td valign=center><b><font size=\"2\"> ";?>
  <?php echo $PendetaSidhi; ?><?php echo " </font></b></td></font><td></td></td></tr>";	 
...
//  echo "<tr><td><td valign=top><font size=\"2\">  No. Stmb </td><td>:</td><td><font size=\"2\"><b> " . $NomorIndukIbu . " </b></td></font><td></td></td>";
  ...
  echo "<tr><td><td valign=top><font size=\"2\">  Nomor Surat Titipan </td><td>:</td><td><font size=\"2\"><b> " . $NoSuratTitipan . " </b></td></font><td></td></td>";	
 ...
 ?>
  ...
  Dengan ini Majelis ".$sChurchFullName." menyerahkan kembali saudara tersebut kepada Majelis " . $NamaGerejaGKJ . "
  . Demikian pemberitahuan ini kami sampaikan, atas pelayanannya kami ucapkan terima kasih. 
