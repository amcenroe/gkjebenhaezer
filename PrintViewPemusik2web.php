...
/*******************************************************************************
 *
 *  filename    : PrintViewPemusik2web.php
...
$Judul = "Laporan - Daftar Pemusik / Organis "; 
...
left join family_fam c ON c.fam_ID = a.per_fam_ID,
person2volunteeropp_p2vo, volunteeropportunity_vol
where 
a.per_id = p2vo_per_id AND p2vo_vol_id = vol_id 
AND vol_id = 203
...
//Print_r ($_SESSION);
		$logvar1 = "Report";
		$logvar2 = "Daftar Pemusik / Organis (web) ";
		//Update Logger
