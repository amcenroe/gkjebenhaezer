...
/*******************************************************************************
 *
 *  filename    : PrintViewAbsensiDPT.php
...
//echo $Kelas
				...
				while ($hasilGD=mysql_fetch_array($perintah))
				{
					...
					echo "<a href=PrintViewAbsensiDPT.php?Kel=".$hasilGD[Kelompok]. "> ".$hasilGD[Kelompok]. " </a> | ";
				}
				echo "<a href=PrintViewAbsensiDPT.php> Semua</a> ";
?>
			...
			<td align=CENTER width="400" ><b><font size="2">Tanda Tangan </font></b></td>
			...
			<?php
				...
				<td height="35" align=CENTER ><font size="2"><a href="PrintViewUndanganDPT.php?perID=<?=$hasilGD[KodeID]?>&Mode=2" target="_BLANK" ><? echo $i ?></a></td>
				...
				//				echo "<img border=\"0\" src=\"Images/1piksel.jpg\" height=\"35\" >" ;
				...
				<?php 
					if ($i % 2 == 0) {
					echo "<td WIDTH=300 ALIGN=CENTER><font size=\"2\">(".$i.")</td>";
					} else {
					echo "<td ALIGN=LEFT><font size=\"2\">(".$i.")</td>";
					}
				?>
				</tr>
				<?}?>
