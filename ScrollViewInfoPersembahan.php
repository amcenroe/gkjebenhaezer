...
<?
				...
				echo "</tr>";
				echo "<tr>";
				echo "<td width=280><font face=\"Arial\" size=\"3\"><b>Tempat Ibadah</b></font></td>";
				echo "<td width=120><font face=\"Arial\" size=\"3\"><b>Waktu</b></font></td>";
				echo "<td width=60><font face=\"Arial\" size=\"3\"><b>Hadir</b></font></td>";
				echo "<td width=350><font face=\"Arial\" size=\"3\"><b>Pelayan Ibadah</b</font></td>";
...
// echo "<li><table><tr><td align=\left\" ><b>".integerToRoman($i)."</b></td><td colspan=\"12\" ><b> ".$NamaTI."</b></td></li></tr>";
	...
	// Ibadah Dewasa		
		...
		$TotalJemaat = $Pria + $Wanita ;	
		 ...
		 <td align=\"center\" width=\"120\"> ".$Pukul." </td>
		 <td  align=\"center\" width=\"60\"> ".$TotalJemaat."</td>
		 <td width=\"370\"> ".mb_strimwidth($Pengkotbah, 0, 30, "..")."</td>
 ...
 // Ibadah Anak 
		...
		$TotalJemaatAnak = $AnakPria + $AnakWanita ;	
		 ...
		 <td align=\"center\"  width=\"120\">".$PukulAnak." </td>
		 <td  align=\"center\"  width=\"60\"> ".$TotalJemaatAnak."</td>
		 <td  width=\"370\"> ".mb_strimwidth($PengkotbahAnak, 0, 30, "..")."</td>
		 <td align=\"right\"  width=\"150\"> ".currency(' ',$PersembahanAnak,'.',',00')." </td>
		 <td></td></tr></table></li>";
...
if ($KodeTI==1){		
 ...
 // Ibadah Remaja 
		...
		$TotalJemaatRemaja = $RemajaPria + $RemajaWanita ;	
		 ...
		 <td align=\"center\"  width=\"120\"> ".$PukulRemaja." </td>
		 <td  align=\"center\"  width=\"60\"> ".$TotalJemaatRemaja."</td>
		 <td  width=\"370\"> ".mb_strimwidth($PengkotbahRemaja, 0, 30, "..")."</td>
		 <td align=\"right\"  width=\"150\"> ".currency(' ',$PersembahanRemaja,'.',',00')." </td>
...
// Ibadah PraRemaja 
		...
		$TotalJemaatPraRemaja = $PraRemajaPria + $PraRemajaWanita ;	
		 ...
		 <td align=\"center\"  width=\"120\"> ".$PukulPraRemaja." </td>
		 <td  align=\"center\"  width=\"60\"> ".$TotalJemaatPraRemaja."</td>
		 <td  width=\"370\"> ".mb_strimwidth($PengkotbahPraRemaja, 0, 30, "..")."</td>
		 <td align=\"right\"  width=\"150\"> ".currency(' ',$PersembahanPraRemaja,'.',',00')." </td>
...
// Ibadah Pemuda 
		...
		$TotalJemaatPemuda = $PemudaPria + $PemudaWanita ;	
		 ...
		 <td align=\"center\"  width=\"120\"> ".$PukulPemuda." </td>
		 <td  align=\"center\"  width=\"60\"> ".$TotalJemaatPemuda."</td>
		 <td  width=\"370\"> ".mb_strimwidth($PengkotbahPemuda, 0, 30, "..")."</td>
		 <td align=\"right\"  width=\"150\" > ".currency(' ',$PersembahanPemuda,'.',',00')." </td>
...
// Ibadah Khusus  
		...
		$TotPersembahanKhusus=$TotPersembahanKhusus+$PersembahanKhusus;	
		 ...
		 <td width=\"370\"> ".mb_strimwidth($PengkotbahKhusus, 0, 30, "..")."</td>
		 <td align=\"right\"  width=\"150\"> ".currency(' ',$PersembahanKhusus,'.',',00')." </td>
