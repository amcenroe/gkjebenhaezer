...
if($sMode == 'person')
{
	...
	else
	{
		...
		echo "<BR>";
		echo "<p><h3><a href=\"SelectDelete.php?mode=person&PersonID=" . $iPersonID . "&Confirmed=Yes\">" . gettext("YA, Silahkan HAPUS data ini") . "</a>" . gettext(" (Perhatian! Setelah dihapus tidak bisa direcovery)") . "</h3></p>";
