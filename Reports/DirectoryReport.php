...
class PDF_Directory extends ChurchInfoReport {
    ...
    function Header()
    {
        ...
        if (($this->PageNo() > 1) || ($bDirUseTitlePage == false))
        {
            ...
            //Framed title
          //  $this->Cell($this->w - ($this->_Margin_Left*2),10,$this->gettext("Buku Alamat "),1,0,'C');
            $this->Cell($this->w - ($this->_Margin_Left*2),10,$this->sChurchName . " - " . gettext("Daftar Jemaat"),1,0,'C');
