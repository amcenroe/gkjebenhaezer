...
/*******************************************************************************
 *
 *  filename    : PrintViewBaptisAnakSK.php
 *
...
$sSQL = "select a.* , z.BaptisID, z.NoSuratTitipan, z.PendetaBaptis,
		...
		f.NamaGereja as TempatBaptisNW,
...
<table border="0"  width="600" cellspacing=0 cellpadding=0>
  <tr><!-- Row 1 -->
   ...
   echo "<tr><td valign=top>Nomor Surat:</td><td><font size=\"2\">  " . $BaptisID . "e/SKPBA/".$sChurchCode."/"; echo dec2roman(date (m)) ;echo "/"; echo date('Y');"</font></td>";
  
  echo "<td>".$sChurchCity.", </td><td>"; echo tanggalsekarang() ; date ('Y' ); echo " </td></tr>";
   echo "<tr><td valign=top>Hal:</td><td><font size=\"2\"> Surat Keterangan Pelayanan Baptis </font></td></tr>";
 ...
 sudah dilayankan Pelayanan Baptis  :</font></td>"; 
 ?>
  <?php 
 ...
 echo "<tr><td><td valign=center><font size=\"2\">  Tempat </td><td>:</td><td valign=center><b><font size=\"2\"> ";?>
  ...
  echo "<tr><td><td valign=center><font size=\"2\">  Dibaptis oleh </td><td>:</td><td valign=center><b><font size=\"2\"> ";?>
  <?php echo $PendetaBaptis; ?><?php echo " </font></b></td></font><td></td></td></tr>";	 
