...
$sPageTitle = gettext("Laporan Per-Kelompok");
...
<p align="center"><?php echo gettext("Silahkan Pilih Kelompok Yang akan dibuatkan Laporannya:"); ?></p>
<form method="POST" action="GroupReports.php">
<table align="center">
	<tr>
		<td class="LabelColumn"><?php echo gettext("Pilih Kelompok:"); ?></td>
		<td class="TextColumn">
			<?php
	...
	<tr>
		<td class="LabelColumn"><?php echo gettext("Status Keanggotaan:"); ?></td>
		<td class="TextColumn"><span id="GroupRole"><?php echo gettext("Kelompok Belum Dipilih"); ?></span></td>
	</tr>
	<tr>
<?php //			<td class="LabelColumn"><?php echo gettext("Only cart persons?:"); ?></td>  ?>
<?php //			<td class="TextColumn"><input type="checkbox" Name="OnlyCart" value="1"></td>  ?>
	</tr>

	<tr>
<?php //			<td class="LabelColumn"><?php echo gettext("Report Model:"); ?></td>
<?php //			<td class="TextColumn">  ?>
<?php //				<input type="radio" Name="ReportModel" value="1" checked><?php echo gettext("Report for group and role selected"); ?><br>
<?php //				<input type="radio" Name="ReportModel" value="2"><?php echo gettext("Report for any role in group selected"); ?><br>
...
<p align="center" class="MediumText"><?php echo gettext("Silahkan pilih informasi yang akan ditampilkan"); ?></p>

<table align="center">
	<tr>
		<td class="LabelColumn"><?php echo gettext("Standard Info:"); ?></td>
		<td class="TextColumn">
			<input type="checkbox" Name="AddressEnable" value="1"> <?php echo gettext("Alamat");?> <br>
			<input type="checkbox" Name="HomePhoneEnable" value="1"> <?php echo gettext("Telepon");?> <br>
<?php //	<input type="checkbox" Name="WorkPhoneEnable" value="1"> <?php echo gettext("Work Phone");?>
			<input type="checkbox" Name="CellPhoneEnable" value="1"> <?php echo gettext("Handphone");?> <br>
			<input type="checkbox" Name="EmailEnable" value="1"> <?php echo gettext("Email");?> <br>
<?php //	<input type="checkbox" Name="OtherEmailEnable" value="1"> <?php echo gettext("Other Email");?>
<?php //	<input type="checkbox" Name="GroupRoleEnable" value="1"> <?php echo gettext("GroupRole");?>
		</td>
	</tr>
<?php //	<tr>
...
<p align="center">
<BR>
<input type="submit" class="icButton" name="Submit" <?php echo 'value="' . gettext("Buat Laporan") . '"'; ?>>
