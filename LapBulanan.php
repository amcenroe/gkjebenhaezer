...
$SelisihTahunMandiri2009 = $THNSKR - 2009 ;
...
$sSQL = "select count(*) from person_per natural join person_custom, family_fam
where person_per.per_fam_id = family_fam.fam_id AND per_BirthYear = $TAHUNTH 
order by per_workphone, per_FirstName";
$perintah = mysql_query($sSQL);
...
<table
 ...
 border="0" cellpadding="2" cellspacing="2">
  <tbody>
	...
	<font size="2"><big style="font-family: Arial;"><?php //echo $SelisihTahunMandiri2009;?> Laporan (Executive Sumary) - Tahun <? echo $THNSKR ?></big><br></font></b>   
...
$iA=1;
while($iA<=$SelisihTahunMandiri2009)
  {
  $TAHUNTH=2009+$iA;
  //pengurangan
...
//echo "<td><font size=2> <ALIGN=center>";  echo $TAHUNTH;  echo "</font></td>";
 ...
 // echo $TAHUNTH;
  $iA++;
   ...
   $jemaataktifselisih = ($datatempkelahiranth + $datatempatestasith + $datatempbaptisdewasath) - ($datatempkematianth + $datatemppindahth + $datatemppindahagmth ) ;
