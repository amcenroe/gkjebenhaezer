  ...
  <tbody>
    <tr>
      <td style="font-family: Arial; width: 380px; text-align: left; color: rgb(0, 0, 102);" valign=top>
		...
		Grafik Kehadiran Pemuda Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=4" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=4&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
				<br>
		<? minavgmax(5,$iTahun);   ?>
		<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		Grafik Kehadiran Remaja Tahun : <?=$iTahun?> </a>
		</b><br>
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=5" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=5&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
				<br>
		<? minavgmax(15,$iTahun);   ?>
