  ...
  <tbody>
    <tr>
      <td style="font-family: Arial; width: 380px; text-align: left; color: rgb(0, 0, 102);" valign=top>
		...
		<br>
		Jenis Graphic : 
		<a href="LapBulanan_hadir.php?Tahun=<?=$iTahun?>&Jenis=Bar" >Batang</a> - 
		<a href="LapBulanan_hadir.php?Tahun=<?=$iTahun?>&Jenis=Line" >Garis</a>
		</font>
		</font>
    	<br>
		<br>
		...
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=12&Jenis=<?=$iJenis?>" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=12&amp;&Jenis=".$iJenis."&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		...
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=3&Jenis=<?=$iJenis?>" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=3&amp;&Jenis=".$iJenis."&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br><br>
		<? minavgmax(14,$iTahun);   ?>
		<b><a href="ListEvents.php?Tahun=<?=$iTahun?>" target="_blank">
		...
		<a href="graph_kehadiran.php?Tahun=<?=$iTahun?>&Kolom=14&Jenis=<?=$iJenis?>" width="2048" target="_blank">
 		<?php	echo "<img src=\"graph_kehadiran.php?Tahun=".$iTahun."&Kolom=14&amp;&Jenis=".$iJenis."&amp;".$refresh." \" width=\"1024\" ><br>" ;	?>
		</a><font size="1"><i>* Catatan: Untuk Memperbesar Gambar,Silahkan Klik Grafik tersebut</i></font>
		<br>
