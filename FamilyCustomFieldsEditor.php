...
$sPageTitle = gettext("Editor Informasi Tambahan untuk Keluarga");
...
?>
    <tr><td colspan="7">
    <center><b><?php echo gettext("Warning: Arrow and delete buttons take effect immediately.  Field name changes will be lost if you do not 'Simpan' before using an up, down, delete or 'add new' button!"); ?></b></center>
    </td></tr>
    ...
    ?>
        ...
        <tr>
            ...
            <input type="submit" class="icButton" value="<?php echo gettext("Simpan"); ?>" Name="SaveChanges">
            &nbsp;
            <input type="button" class="icButton" value="<?php echo gettext("Exit"); ?>" Name="Exit" onclick="javascript:document.location='Menu.php';">
            </td>
        </tr>
