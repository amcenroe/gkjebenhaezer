...
$sPageTitle = gettext("Daftar Pengguna");
require "Include/Header.php";

?>

<p align="center"><a href="UserEditor.php"><?php echo gettext("Tambah Pengguna Baru"); ?></a></p>

<table cellpadding="4" align="center" cellspacing="0" width="100%">
	<tr class="TableHeader">
		<td><b><?php echo gettext("Nama"); ?></b></td>
		<td align="center"><b><?php echo gettext("Login Terakhir"); ?></b></td>
		<td align="center"><b><?php echo gettext("Total Login"); ?></b></td>
		<td align="center"><b><?php echo gettext("Login Gagal"); ?></b></td>
		<td align="center" colspan="2"><b><?php echo gettext("Kata Kunci"); ?></b></td>
		<td><b><?php echo gettext("Edit"); ?></b></td>
		<td><b><?php echo gettext("Hapus"); ?></b></td>
	</tr>
<?php
...
?>
	<tr class="<?php echo $sRowClass; ?>">
		...
		<td align="right"><a href="UserPasswordChange.php?PersonID=<?php echo $per_ID; ?>&FromUserList=True"><?php echo gettext("Rubah"); ?></a></td>
		...
		<td><a href="UserDelete.php?PersonID=<?php echo $per_ID; ?>"><?php echo gettext("Hapus"); ?></a></td>
	</tr>
<?php
}
?>
