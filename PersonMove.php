			...
			<tr>
				...
				<td class="TextColumn">
					<select name="Family" size="8">
						...
						<option value="-1"><?php echo gettext("Buat Keluarga Baru(Dengan Nama Belakang)"); ?></option>
...
<?php if (!$bHidePersonAddress) { /* Person Address can be hidden - General Settings */ ?>
			...
			<tr>
				<td class="LabelColumn" <?php addToolTip("Main address for an individual. If the address does not differ from the family, leave this field blank."); ?>><?php if ($bFamilyAddress1) { echo "<span style=\"color: red;\">"; } ?><?php echo gettext("Alamat1:"); ?></span></td>
			...
			<tr>
				<td class="LabelColumn" <?php addToolTip("Additional information if needed. If the address does not differ from the fmaily, leave this field blank."); ?>><?php if ($bFamilyAddress2) { echo "<span style=\"color: red;\">"; } ?><?php echo gettext("Alamat2:"); ?></span></td>
