	...
	/* siapkan data yang akan membentuk grafik oval
	   pada grafik ada data yang disiapkan */
		...
		// Some data
				...
				$sSQL = "select count(per_ID) as Jumlah
						from person_per, bulan
						WHERE person_per.per_BirthMonth = bulan.kode AND per_cls_ID < 3 AND person_per.per_BirthMonth >0
...
//	$graph->title->Set("Prosentasi Gol Darah");
