...
//Header
				...
				echo "<tr>";
				echo "<td colspan=\"6\" ><font face=\"Arial\"><u><b>Persembahan Bulanan ( Kartu Merah ) , ".date2Ind($iTGL,1)."</b></u></font></td>";
				echo "</tr>";
				echo "<tr>";
				echo "<td width=190><font face=\"Arial\"><b>Kelompok-NoKartu.Kode</b></font></td>";
...
//Minggu Ini
	...
	//		}
		...
		//	echo "<td> ".$i." </td>";
			...
			echo "<td width=\"80\"> ".$Kelompok." </td>";
			echo "<td width=\"80\"> ".$NomorKartu."<br>".$KodeNama."".$KodeNama2." </td>";
		//	echo "<td width=\"55\" align=\"center\"> ".$Bulan1;if (strlen($Bulan2>0)){echo "-".$Bulan2;};echo " | </td>";
			echo "<td width=\"250\" align=\"right\"> ".currency(' ',$Bulanan,'.','')." | </td>";
			echo "<td width=\"250\" align=\"right\"> ".currency(' ',$Syukur,'.','')." | </td>";
			echo "<td width=\"250\" align=\"right\"> ".currency(' ',$ULK,'.','')." | </td>";
			$Total=$Bulanan+$Syukur+$ULK;
			echo "<td width=\"250\" align=\"right\"> ".currency(' ',$Total,'.','')." </td>";	
			echo "</font>";
			echo "</tr></table></li>";
		}
